export function ImportInstructions(): React.JSX.Element {
  return (
    <div className="space-y-3">
      ...
      <details className="group border border-slate-700 rounded-lg">
        <summary className="cursor-pointer px-4 py-3 text-sm font-medium text-slate-300 hover:text-slate-100 select-none">
          How to Import into Avid Media Composer
        </summary>
        <div className="px-4 pb-4 text-sm text-slate-400 space-y-4">
          <section>
            <h3 className="text-slate-300 font-medium mb-1">
              Method 1 — Import to Bin
            </h3>
            <ol className="list-decimal list-inside space-y-1">
              <li>Download/save the .srt file</li>
              <li>
                Right-click in a{' '}
                <strong className="text-slate-300">Bin</strong> and select{' '}
                <strong className="text-slate-300">Import...</strong>
              </li>
              <li>
                Set the file type filter to{' '}
                <strong className="text-slate-300">All Files</strong> or{' '}
                <strong className="text-slate-300">Subtitle/Caption</strong> if
                available
              </li>
              <li>Select your .srt file and click Open</li>
              <li>
                The subtitle data appears as a new clip in the bin — edit it into
                your sequence like any other media
              </li>
            </ol>
          </section>
          ...
          <section>
            <h3 className="text-slate-300 font-medium mb-1">
              Method 2 — SubCap Effect
            </h3>
            <ol className="list-decimal list-inside space-y-1">
              <li>
                Add a <strong className="text-slate-300">SubCap</strong> effect to
                a filler track on your timeline
              </li>
              <li>
                Open the{' '}
                <strong className="text-slate-300">Effect Editor</strong>
              </li>
              <li>
                Use the import option within SubCap to load the .srt file
              </li>
              <li>
                Subtitles populate as individual caption events on the timeline
              </li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1">
              <li>
                Open the SubCap effect to change font, size, color, and
                positioning
              </li>
              <li>
                Apply changes to individual entries or all at once
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1">
              <li>
                .srt not showing in import? Set file filter to "All Files"
              </li>
              <li>
                Garbled characters? Ensure file is UTF-8 (gimmesubs always outputs
                UTF-8)
